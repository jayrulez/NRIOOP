...
Result PipelineLayoutVK::Create(const PipelineLayoutDesc& pipelineLayoutDesc)
{
    ...
    VkPushConstantRange* pushConstantRanges = ALLOCATE_SCRATCH(m_Device.GetStdAllocator(), VkPushConstantRange, pipelineLayoutDesc.pushConstantNum);
    ...
    FREE_SCRATCH(m_Device.GetStdAllocator(), pushConstantRanges, pipelineLayoutDesc.pushConstantNum);
...
void PipelineLayoutVK::CreateSetLayout(const DescriptorSetDesc& descriptorSetDesc, const uint32_t* bindingOffsets)
{
    ...
    VkDescriptorSetLayoutBinding* bindings = ALLOCATE_SCRATCH(m_Device.GetStdAllocator(), VkDescriptorSetLayoutBinding, bindingMaxNum);
    VkDescriptorBindingFlagsEXT* bindingFlags = ALLOCATE_SCRATCH(m_Device.GetStdAllocator(), VkDescriptorBindingFlagsEXT, bindingMaxNum);
    ...
    FREE_SCRATCH(m_Device.GetStdAllocator(), bindingsBegin, bindingMaxNum);
    FREE_SCRATCH(m_Device.GetStdAllocator(), bindingFlagsBegin, bindingMaxNum);
}
