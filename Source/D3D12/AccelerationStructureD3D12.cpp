...
Result AccelerationStructureD3D12::CreateDescriptor(uint32_t physicalDeviceMask, Descriptor*& descriptor) const
{
...
uint64_t AccelerationStructureD3D12::GetHandle(uint32_t physicalDeviceMask) const
{
