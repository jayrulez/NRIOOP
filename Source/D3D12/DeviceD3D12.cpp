...
DeviceD3D12::DeviceD3D12(const Logger& log, StdAllocator<uint8_t>& stdAllocator)
...
inline Result DeviceD3D12::CreateCommandAllocator(const CommandQueue& commandQueue, uint32_t physicalDeviceMask, CommandAllocator*& commandAllocator)
{
...
inline Result DeviceD3D12::CreateBufferView(const BufferViewDesc& bufferViewDesc, Descriptor*& bufferView)
{
    return CreateImplementation<DescriptorD3D12>(bufferView, bufferViewDesc);
}

inline Result DeviceD3D12::CreateTexture1DView(const Texture1DViewDesc& textureViewDesc, Descriptor*& textureView)
{
    return CreateImplementation<DescriptorD3D12>(textureView, textureViewDesc);
}

inline Result DeviceD3D12::CreateTexture2DView(const Texture2DViewDesc& textureViewDesc, Descriptor*& textureView)
{
    return CreateImplementation<DescriptorD3D12>(textureView, textureViewDesc);
}

inline Result DeviceD3D12::CreateTexture3DView(const Texture3DViewDesc& textureViewDesc, Descriptor*& textureView)
{
    return CreateImplementation<DescriptorD3D12>(textureView, textureViewDesc);
}
...
inline Result DeviceD3D12::CreateSampler(const SamplerDesc& samplerDesc, Descriptor*& sampler)
{
...
inline Result DeviceD3D12::CreateGraphicsPipeline(const GraphicsPipelineDesc& graphicsPipelineDesc, Pipeline*& pipeline)
{
    return CreateImplementation<PipelineD3D12>(pipeline, graphicsPipelineDesc);
}

inline Result DeviceD3D12::CreateComputePipeline(const ComputePipelineDesc& computePipelineDesc, Pipeline*& pipeline)
{
    return CreateImplementation<PipelineD3D12>(pipeline, computePipelineDesc);
}

inline Result DeviceD3D12::CreateRayTracingPipeline(const RayTracingPipelineDesc& rayTracingPipelineDesc, Pipeline*& pipeline)
{
...
void DeviceD3D12::DestroyCommandBuffer(CommandBuffer& commandBuffer)
{
...
inline Result DeviceD3D12::AllocateMemory(uint32_t physicalDeviceMask, const MemoryType memoryType, uint64_t size, Memory*& memory)
{
...
{
    HelperDeviceMemoryAllocator allocator((Device&)*this, m_StdAllocator);
...
Result CreateDeviceD3D12(const DeviceCreationD3D12Desc& deviceCreationDesc, Device*& device)
{
    Logger log(GraphicsAPI::D3D12, deviceCreationDesc.callbackInterface);
...
Result CreateDeviceD3D12(const DeviceCreationDesc& deviceCreationDesc, Device*& device)
{
    Logger log(GraphicsAPI::D3D12, deviceCreationDesc.callbackInterface);
    StdAllocator<uint8_t> allocator(deviceCreationDesc.memoryAllocatorInterface);
