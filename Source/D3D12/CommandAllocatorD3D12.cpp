...
void CommandAllocatorD3D12::SetDebugName(const char* name)
{
    SET_D3D_DEBUG_OBJECT_NAME(m_CommandAllocator, name);
}

Result CommandAllocatorD3D12::CreateCommandBuffer(CommandBuffer*& commandBuffer)
{
...
void CommandAllocatorD3D12::Reset()
{
