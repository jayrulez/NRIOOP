...
namespace nri
{
    ...
    struct NRI_D3D11_API PipelineD3D11 : public Pipeline
    {
        ...
        virtual  Result WriteShaderGroupIdentifiers(uint32_t baseShaderGroupIndex, uint32_t shaderGroupNum, void* buffer) const override { return Result::UNSUPPORTED; }

    private:
        const VersionedDevice* m_VersionedDevice = nullptr;
