...
namespace nri
{
    struct NRI_D3D11_API DescriptorD3D11 : public Descriptor
    {
        ...
        static void CreateSamplerState(const Logger& log, const VersionedDevice& device, const SamplerDesc& samplerDesc, ID3D11SamplerState** samplerState);
