...
inline DeviceD3D11& nri::CommandQueueD3D11::GetDevice() const
{
    return m_Device;
}
...
{
    HelperResourceStateChange resourceStateChange((Device&)m_Device, (CommandQueue&)*this);
...
{
    HelperDataUpload helperDataUpload((Device&)m_Device, m_Device.GetStdAllocator(), (CommandQueue&)*this);
...
{
    HelperWaitIdle helperWaitIdle((Device&)m_Device, (CommandQueue&)*this);
