...
void DescriptorSetD3D11::SetDebugName(const char* name)
{
    MaybeUnused(name);
}

void DescriptorSetD3D11::UpdateDescriptorRanges(uint32_t physicalDeviceMask, uint32_t rangeOffset, uint32_t rangeNum, const DescriptorRangeUpdateDesc* rangeUpdateDescs)
{
...
void DescriptorSetD3D11::UpdateDynamicConstantBuffers(uint32_t physicalDeviceMask, uint32_t baseBuffer, uint32_t bufferNum, const Descriptor* const* descriptors)
{
...
void DescriptorSetD3D11::Copy(const DescriptorSetCopyDesc& descriptorSetCopyDesc)
{
