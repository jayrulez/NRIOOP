...
Result CommandBufferD3D11::Begin(const DescriptorPool* descriptorPool, uint32_t physicalDeviceIndex)
{
...
void nri::CommandBufferD3D11::CopyBuffer(Buffer& dstBuffer, uint32_t dstPhysicalDeviceIndex, uint64_t dstOffset, const Buffer& srcBuffer, uint32_t srcPhysicalDeviceIndex, uint64_t srcOffset, uint64_t size)
{
...
void nri::CommandBufferD3D11::CopyTexture(Texture& dstTexture, uint32_t dstPhysicalDeviceIndex, const TextureRegionDesc* dstRegionDesc, const Texture& srcTexture, uint32_t srcPhysicalDeviceIndex, const TextureRegionDesc* srcRegionDesc)
{
...
void CommandBufferD3D11::ReadbackTextureToBuffer(Buffer& dstBuffer, TextureDataLayoutDesc& dstDataLayoutDesc, const Texture& srcTexture, const TextureRegionDesc& srcRegionDesc)
{
    ...
    CopyTexture((Texture&)dstTemp, 0, &dstRegionDesc, srcTexture, 0, &srcRegionDesc);
}
