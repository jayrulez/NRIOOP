        ...
        case COPY_BUFFER:
            {
                ...
                commandBuffer.CopyBuffer(*dstBuffer, 0, dstOffset, *srcBuffer, 0, srcOffset, size);
            }
            break;
        case COPY_TEXTURE:
            {
                ...
                commandBuffer.CopyTexture(*dstTexture, 0, &dstRegion, *srcTexture, 0, &srcRegion);
            }
            break;
...
inline Result CommandBufferEmuD3D11::Begin(const DescriptorPool* descriptorPool, uint32_t physicalDeviceIndex)
{
    m_PushBuffer.clear();
...
void nri::CommandBufferEmuD3D11::CopyBuffer(Buffer& dstBuffer, uint32_t dstPhysicalDeviceIndex, uint64_t dstOffset, const Buffer& srcBuffer, uint32_t srcPhysicalDeviceIndex, uint64_t srcOffset, uint64_t size)
{
...
void nri::CommandBufferEmuD3D11::CopyTexture(Texture& dstTexture, uint32_t dstPhysicalDeviceIndex, const TextureRegionDesc* dstRegionDesc, const Texture& srcTexture, uint32_t srcPhysicalDeviceIndex, const TextureRegionDesc* srcRegionDesc)
{
